...
export function DurationSettings({ settings, updateSettings }: ISettingsHelperProps): React.JSX.Element {
  return (
...
export function QuestionCountSettings({ settings, updateSettings }: ISettingsHelperProps): React.JSX.Element {
  return (
    <div className="space-y-2">
...
export function DifficultySettings({ settings, updateSettings }: ISettingsHelperProps): React.JSX.Element {
  return (
    <div className="space-y-2">
...
export function FocusAreaSettings({ settings, updateSettings }: ISettingsHelperProps): React.JSX.Element {
  return (
    <div className="space-y-2">
