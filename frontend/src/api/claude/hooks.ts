...
import { createClaudeQueryKey, createPracticeQueryKey } from "@/query/client";

import { claudeApi } from "./client";
import type {
  IClaudeResponse,
...
export const claudeQueryUtils = {
   ...
   */
  invalidateAll: () => claudeApi.generateQuestions.bind(null), // TODO: Implement with actual query client
  /**
   * Clear specific question cache
   */
  clearQuestions: (request: IQuestionGenerationRequest) => {
