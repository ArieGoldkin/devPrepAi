...
const MILLISECONDS_PER_DAY = MILLISECONDS_IN_SECOND * SECONDS_IN_MINUTE * MINUTES_IN_HOUR * HOURS_IN_DAY
...
export function useStreak(): {
  ...
  const getStreakData = useCallback((): IStreakData => {
    const today = getTodayDateString()
    const shouldResetStreak = Boolean(streakData.lastActivityDate &&
