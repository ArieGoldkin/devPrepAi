...
export default function DemoPage(): React.JSX.Element {
  ...
  const getProgressPercentage = (): number => ((currentQuestionIndex + 1) / sampleQuestions.length) * 100
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Experience our assessment platform with sample questions. This is a preview of the full assessment experience.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              This is a demonstration. Your answers will not be saved or evaluated.
            </CardDescription>
          </CardHeader>
        </Card>
